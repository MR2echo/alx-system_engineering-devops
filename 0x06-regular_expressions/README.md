...
* **2. Repetition Token #1**
  * [2-repetition_token_1.rb](./2-repetition_token_1.rb): Ruby script . Textme**
  ...
  * Output: `[SENDER],[RECEIVER],[FLAGS]` where
    ...
    * `[RECEIVER]` is the receiver phone number or name (including country code
    if present).
    * `[FLAGS]` is the flags that were used.that matches
...
* **4. Repetition Totoken_3.rbth 0 or more `t`'s in between `hb` and `n`.
...
* **6. Call me maybe**
  * [6-phone_number.rb](./6-phone_number.rb): Ruby scripthone number.
