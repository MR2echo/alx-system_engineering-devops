...
* **0. OSI model**
  ...
  * How is the OSI model organized?
    1. Alphabe 3. A network interface
...
* **3. UDP and TCP**
  ...
  * Which statehat is transferring data in a slow way but surely
    2. It is a protocol that is transferring data in a fast way and might loss
    data along in the process
  * Which statement is correct for the UDP box:
    1. It is a protocol that is transferrings transferring data in a fast way and might loss
    data along in the process
...
* **4. TCP and UDP ports**
  * [4-TCP_and_UDP_ports](./4ports.
  * Only shows listening sockets.
host_on_the_network {IP_ADDRESS}`.tically
    2. From the lowest to the highest level
    3. Randomly

* **1. Types of network**
  * [1-types_of_network](./1-types_of_netwpe of network a computer in local is connected to?
    1. Internet
    2. WAN
    3. LAN
